...
REMOVE_DATASETS_CACHE="${REMOVE_DATASETS_CACHE:-}"
...
HF_DATASETS_CACHE="${DATASETS_CACHE_DIR}" HF_DATASETS_IN_MEMORY_MAX_SIZE=23400000 \
...
if [[ "${REMOVE_DATASETS_CACHE}" == "1" ]]; then
